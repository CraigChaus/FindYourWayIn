...
export const EventInfo = ({name , description , timeStart , timeEnd , housenr , street, city , zipcode , website }:any) => {
  return (
    <>
        <div>
            <h1 className='text-center font-bold mb-8 p-4'>{name}</h1>
            <p className='text-center border-t-2 border-b-2 border-black pb-4'>{description}</p>
            <div className='mt-8 space-y-2 border-b-2 border-black '>
              ...
              <div className='flex space-x-2'>
                ...
                <p>{street} , {housenr}, {zipcode}, {city}</p>
              </div>
              <div className='flex space-x-2'>
