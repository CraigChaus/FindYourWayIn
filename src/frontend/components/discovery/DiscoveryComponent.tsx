...
<div className="px-5">
           <div className="flex   flex-raw border-white border-b-4 h-20 w-full " >
               <div className=" flex  justify-center  h-full w-1/2 p-3" >
                   <button className="flex justify-center w-full h-15 mx-2 rounded hover:bg-zinc-300 pt-5 font-bold text-white">Suggestions</button>
               </div>
               <div className="flex justify-center   h-full w-1/2 p-3">
                   <button className="flex justify-center w-full h-15 mx-2 rounded hover:bg-zinc-300 pt-5 font-bold text-white ">Favorite</button></div>
           </div>

</div>
          <div className="flex w-full h-10  font-bold text-white justify-center pt-3"><h1>SHOPS</h1></div>
            ...
            <div className=" flex flex-col justify-center border-orange-700 flex    h-1/3 w-full  ">
                <div className="  flex justify-center h-1/5 pt-5">
                    ...
                    <div className="flex justify-center h-4/5 p-5">
                        <div className="   bg-cyan-300 flex justify-center w-full h-full rounded-3xl mx-20">
