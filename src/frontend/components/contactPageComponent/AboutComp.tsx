...
const AboutComp = () => {
    ...
    return (
        <>
            ...
            <body
                id="bodyAbout"
                className=" bg-[url('../public/images/imageWalstraat.jpg')]  h-screen w-full bg-cover"
            >
                <section
                    id="section"
                ...
                >
                  ...
                  "
                                    ...
                                    <p id="firstParagraph" className=" indent-4 text-base text-body-color  px-2 w-full text-justify mb-2">
                                        ...
                                        on discounts and special offers are
                                        updated every day so that no one misses
                                        the opportunity to take advantage of
                                        them. The user of the application can
                                        build a route to destinations, as well
