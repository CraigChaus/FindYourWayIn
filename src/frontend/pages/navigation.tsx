    ...
    return (
        <div  className="flex  flex-col h-screen border-black border-4 bg-gray-900">
            <div id="header" className="flex justify-start h-16 bg-zinc-100 rounded-b-2xl z-20">
                <button  className=" h-12 w-12  hover:bg-gray-500 text-black font-bold border-black  rounded m-2"
           ...
           <input className=" h-10 w-full mx-4 my-3 rounded-md border-black border-2"/>
            </div>
